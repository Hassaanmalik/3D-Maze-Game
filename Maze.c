...
void initCamera(){
	...
	pitchSensitivity = 0.2; // up and down
	yawSensitivity   = 0.2; // left and right
...
int main(int argc, char** argv)
{
	...
	window1 = glutCreateWindow("Maze 2D");	//creates the window
	glutCallBacks();
	init();
	...
	window2 = glutCreateWindow("Maze 3D");
	glutCallBacks2();
	init2();
